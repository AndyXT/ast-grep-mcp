...
class TestCHandler:
    ...
    def test_get_default_patterns(self):
        ...
        basic_constructs = [
            "function", "struct", "variable", "comment", "enum", 
            "typedef", "function_pointer", "macro", "include", "switch"
        ]
        ...
        anti_patterns = [
            "goto", "magic_number", "nested_conditional",
            "large_function", "global_var", "deeply_nested_loop"
        ]
        ...
        performance_patterns = [
            "unnecessary_copy", "inefficient_string_concat", 
            "malloc_without_check", "repeated_array_element_access", "redundant_condition"
        ]
        ...
        security_patterns = [
            "buffer_overflow", "format_string_vulnerability", "gets_call",
            "integer_overflow", "null_pointer_deref", "use_after_free"
        ]
        ...
        refactoring_patterns = [
            "if_return_pattern", "void_parameter", "switch_without_default",
            "multiple_return_paths", "malloc_sizeof_type", "redundant_null_check"
        ]
