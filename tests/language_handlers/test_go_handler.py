...
class TestGoHandler:
    ...
    def test_get_default_patterns(self):
        ...
        basic_constructs = [
            "function", "struct", "variable", "comment", "interface", 
            "method", "import", "for_loop", "range_loop", "switch"
        ]
        ...
        anti_patterns = [
            "naked_return", "empty_interface_param", "panic_call",
            "goroutine_without_sync", "bool_param_leading", "large_struct"
        ]
        ...
        performance_patterns = [
            "string_concat_plus", "inefficient_slice_append", 
            "unnecessary_allocation", "map_without_capacity", "mutex_copy"
        ]
        ...
        security_patterns = [
            "sql_injection", "command_injection", "weak_rand",
            "insecure_temp_file", "http_redirect_open"
        ]
        ...
        refactoring_patterns = [
            "nil_check", "error_check", "nested_if", "explicit_type_conversion",
            "repeated_condition", "switch_two_cases", "map_value_check"
        ]
