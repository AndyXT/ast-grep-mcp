...
class TestServerConfig:
    ...
    def test_from_dict(self):
        ...
        config_dict = {
            ...
            "pattern_config": {"validation_strictness": "strict"},
            "refactoring_config": {"preview_mode": True},
...
class TestConfigFiles:
    ...
    def test_from_yaml_file(self, tmp_path):
        ...
        config_data = {
            ...
            "pattern_config": {"validation_strictness": "relaxed"},
        }
    ...
    def test_from_json_file(self, tmp_path):
        ...
        config_data = {
            ...
            "refactoring_config": {"preview_mode": True, "max_replacements": 50},
        }
