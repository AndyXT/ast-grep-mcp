...
def test_parallel_vs_sequential():
    ...
    try:
        ...
        assert sequential_result["files_with_matches"] == parallel_result["files_with_matches"]
        ...
        for file_path in sequential_files:
            assert (sequential_result["matches"][file_path]["count"] == 
...
@pytest.mark.parametrize("num_files,expected_parallel", [
...
def test_auto_parallel_decision(num_files, expected_parallel):
    ...
    try:
        ...
        try:
            ...
            used_parallel = any("parallel processing" in msg for msg in mock_logger.messages)
            used_sequential = any("sequential processing" in msg for msg in mock_logger.messages)
