...
class MyClass:
    ...
    def test_build_suggestion_message(self):
        ...
        message = build_suggestion_message("def my_function($$$):", "python", suggestions)
...
def example_function(a, b):
    return a + b
        ...
        assert any(("example_function" in v and ":" in v) for v in variants), f"No useful variants among: {variants}"
