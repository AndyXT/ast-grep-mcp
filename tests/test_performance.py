...
from src.ast_grep_mcp.utils.benchmarks import create_synthetic_files, Benchmark, run_benchmarks
...
class TestParallelization:
    ...
    def test_directory_search_parallel(self):
        ...
        assert parallel_result["files_with_matches"] == sequential_result["files_with_matches"]
